          ...
          <div className="contact_info">
            <div className="contact_card">
              ...
              <a href="" className="contact_button">
                Write me{' '}
                <i className="bx bx-right-arrow-alt contact_button_arrow"></i>
              </a>
            </div>
            ...
            <div className="contact_card">
              ...
              <span className="contact_card_data">999-888-777</span>
              <a
                href="mailto:eliabe_trajano@hotmail.com"
        ...
        <div className="contact_content">
          ...
          <form action="" className="contact_form">
            <div className="contact_form_div">
              <label htmlFor="" className="contact_form_tag">
                Name
              </label>
              <input
                type="text"
